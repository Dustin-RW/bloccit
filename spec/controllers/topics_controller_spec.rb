...
RSpec.describe TopicsController, type: :controller do
  ...
  describe "GET index" do
    ...
    it "assigns my_topic to @topics" do
      ...
      expect(assigns(:topics)).to eq([my_topic]) #Why does this eq have []? and #show does not?
    end
  end
#==================================================================
  ...
  describe "GET show" do
    ...
    it "assigns my_topic to @topic" do
      ...
      expect(assigns(:topic)).to eq(my_topic) #??? see index spec for question
    end
...
#==================================================================
  ...
  describe "POST create" do
    ...
    it "increases the amount of topics by 1" do
