...
RSpec.describe CommentsController, type: :controller do
  # instance of id's to use within CommentController spec
  let(:my_user) { User.create!(name: 'Bloccit', email: 'user@bloccit.com', password: 'helloworld') }
  ...
  #==================================================================
  #==================================================================
  context 'member user doing CRUD on a user they own' do
    before do
    ...
    describe 'POST create' do
      ...
      it 'redirects to the post show view' do
        ...
        expect(response).to redirect_to [my_topic, my_post] # same as topic_post_path (/topics/:topic_id/posts/:id) route
      end
    end
