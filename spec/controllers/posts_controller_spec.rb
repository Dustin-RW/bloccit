...
# add SessionsHelper so that we can use the create_session(user)
# method later in the spec.
  ...
  context 'guest user' do
    ...
    describe 'POST create' do
      it 'returns http redirect' do
        get :create, topic_id: my_topic.id, post: { title: RandomData.random_sentence, body: RandomData.random_paragraph }
